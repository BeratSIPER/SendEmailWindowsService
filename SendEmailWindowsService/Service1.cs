...
namespace BeratWindowsService
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            var watcher = new FileSystemWatcher(Settings1.Default.filePath);
            ...
            string[] exts = Settings1.Default.fileExt.Split(',');
            for (int i = 0; i < exts.Length; i++)
            {
                watcher.Filter = exts[i];
            }
        ...
        private static void OnRenamed(object sender, RenamedEventArgs e)
        {
            ...
            if (messageBodyTotal == null)
            {
                messageBodyTotal = $"Renamed: Old {e.OldFullPath}, New {e.FullPath}";

            }
            else
            {
                messageBodyTotal = messageBodyTotal + " and " + $"Renamed: Old: {e.OldFullPath}, New: {e.FullPath}";
            }
